...
Empirical cumulative distribution of simulated (bootstrapped)
             ...
             divided by dimension (evals/DIM) for the $41$ 
             targets $10^{[-6..2]}$ in dimension #1.
}
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.99.1}}
\providecommand{\numofalgs}{1}
\providecommand{\algname}{rs{}}
\providecommand{\algfolder}{rs/}
...
Empirical cumulative distribution of simulated (bootstrapped) runtimes in number
             of evaluations divided by dimension (evals/DIM) for the 
             $41$ targets $10^{[-6..2]}$
...
%
        ...
        target precision values as shown in the top row. 
