...
\providecommand{\cocoversion}{{\scriptsize\sffamily{}\color{Gray}Data produced with COCO v2.6.5a1.dev65+gef8ab15}}
\providecommand{\numofalgs}{3}
...
\providecommand{\algCtables}{\StrLeft{SLSQP-11-scipy Hansen}{\ntables}}
\providecommand{\algBtables}{\StrLeft{NELDERDOERR doerr noiseless}{\ntables}}
\providecommand{\algAtables}{\StrLeft{CMA-ES-pycma Gharafi}{\ntables}}
\providecommand{\ntables}{7}
\providecommand{\pptablesfooter}{
\end{tabularx}
}
...
\providecommand{\algsfolder}{CMA-E_NELDE_SLSQP_cac6/}
\providecommand{\algorithmA}{CMA-ES-pycma Gharafi}
\providecommand{\algorithmB}{NELDERDOERR doerr noiseless}
\providecommand{\algorithmC}{SLSQP-11-scipy Hansen}
